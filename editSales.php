      ...
      <div class="main-content">
          <div class="container my-2">
            <h3>Edit Sales Information</h3>
             <!-- Start Form  -->
            <form action="./salesOp.php?id=<?php echo $id;?>" method="post" class="bg-white p-4 rounded">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control" name="price" placeholder="Enter price" value="<?php echo $price?>" required>
                    </div>
                  ...
                  <div class="form-group  d-flex justify-content-end gap-2">
                    <button type="submit" name="editSales" class="btn btn-info ">Update info</button>
                    <a href="./sales.php" class="btn btn-danger">Cencel</a>
                  </div>
            </form>
