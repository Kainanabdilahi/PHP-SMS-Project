    ...
    <div class="content d-flex flex-column">
      ...
      <div class="main-content">
        ...
        <table class='table my-3 table-bordered bg-white'>
          ...
          $sql = "SELECT id, cname, pname, quantity, price, discount, total FROM sales ORDER BY id DESC";
          ...
          while ($row = $result->fetch_assoc()) {
            ?>   
                         <tr>
                            ...
                            <td>
                              <a href="./editSales.php?id=<?php echo $row["id"] ?>&cname=<?php echo $row["cname"]?>&pname=<?php echo $row["pname"] ?>&quantity=<?php echo $row["quantity"]?>&price=<?php echo $row["price"]?>&discount=<?php echo $row["discount"]?> " class="btn btn-info">Edit</a>
                              <a href="./salesDel.php?id=<?php echo $row["id"] ?>" class="btn btn-danger">Delete</a>
                            </td>
                         </tr>
                    <?php }?>
                   </table>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <!-- Start Form  -->
                <form action="./salesOp.php" method="post">
                  ...
                  <div class="modal-footer">
                    <button type="submit" name="addsales" class="btn btn-success">Add Sale</button>
